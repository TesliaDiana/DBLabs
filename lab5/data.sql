...
DROP TYPE IF EXISTS type_food_characteristic CASCADE;
DROP TABLE IF EXISTS ItemsTypes CASCADE;
DROP TABLE IF EXISTS ItemTypeFood CASCADE;
...
CREATE TYPE type_food_characteristic AS ENUM ('HUNGER', 'HEALTH', 'SANITY');
...
CREATE TABLE IF NOT EXISTS ItemTypeFood 
(
	item_id INTEGER NOT NULL REFERENCES Item(item_id),
	food_characteristic type_food_characteristic NOT NULL,
...
INSERT INTO ItemTypeFood (item_id, food_characteristic, characteristic_value) VALUES 
(12, 'HUNGER', 25),
(12, 'HEALTH', 1),
(12, 'SANITY', -10),
(10, 'HUNGER', 12.5),
